export const entryRefinementEn = {
  ...
  'entry.refine.type.description':
    'Choose the closest category. This only organizes your evidence; it does not score the work.',
  'entry.refine.type.contribution': 'Contribution',
  'entry.refine.type.problemSolved': 'Problem solved',
  'entry.refine.type.feedback': 'Feedback',
  'entry.refine.type.learning': 'Learning',
  'entry.refine.type.ownership': 'Ownership',
  'entry.refine.type.challenge': 'Challenge',
