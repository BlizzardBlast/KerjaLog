  ...
  test('redacts architecture-defined career content key variants', () => {
    ...
    const sentEvent = options.beforeSend?.(
      {
        extra: {
          ...
          workEntryId: 'private-work-entry-id',
          workArea: 'Private work area',
          workAreaId: 'private-work-area-id',
          workAreaName: 'Private work area name',
    ...
    expect(sentEvent).toEqual({
      extra: {
        ...
        workEntryId: '[Filtered]',
        workArea: '[Filtered]',
        workAreaId: '[Filtered]',
        workAreaName: '[Filtered]',
